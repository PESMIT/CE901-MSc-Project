...
public class Teleporter_Script : MonoBehaviour {
	...
	// Room One Assets
	GameObject platform_R1_1, platform_R1_2, teleporter_R1_1,teleporterPad_R1_1, sphere_R1_1;
	Collection_Trigger choice_R1_1, choice_R1_2;
	bool tele_R1;

	// Room Two Assets
	GameObject platform_R2_1, platform_R2_2, teleporter_R2_1,teleporterPad_R2_1, sphere_R2_1;
	...
	void Start () {
		...
		teleporter_R1_1 = GameObject.Find ("Teleporter_R1_1");
		...
		teleporter_R2_1 = GameObject.Find ("Teleporter_R2_1");
